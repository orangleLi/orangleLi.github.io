...
const state = {
    ...
    EOMParams: {
        ...
        getEquipmentAlarmLevelInRecentMonthData: {
            "dataset": "exception_event_dataset",
            "fields": ["level"],
            "metrics": ["__count(event_id)"],
            "filters": {
        ...
        getNearlySevenDaysAlarmTOP5Data: {
            "dataset": "exception_event_dataset",
            "fields": ["project_id","project_name"],
            "metrics": ["__count(event_id)"],
            "filters": {
