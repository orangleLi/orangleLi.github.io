...
setTitleDate.prototype={
    ...
    setTimer:function(){
        ...
        that.options.timer=setTimeout(function(){
            ...
            var content='<span class="title_date"><i>'+options.year+'</i>年<i>'+options.month+'</i>月<i>'+options.day+'日</i></span>'
                +'<span class="title_week">星期<i>'+options.weekDay+'</i></span>'
                +'<span class="title_time"><i>'+options.hour+'</i>:<i>'+options.minute+'</i></span>';
