...
function getValue(name) {
    ...
    $.each(allData, function (item) {
        ...
        if(allData[item].name === name){
            return allData[item].value;
        }
    })
}
// 初始化图表标签
...
//设置区域颜色及隐藏南海诸岛
function setRegions(regionsJson) {
...
// 设置预警数
$('#EarlyingAlarmNum').text(earlyingAlarmingData.length);
//设置告警数
$('#alarmNum').text(alarmData.length)
